...
export const Header = () => {
  ...
  return (
    <div className="bg-white py-4 px-8 w-full fixed flex items-center justify-center">
      <header className=" flex items-center justify-between text-slate-100  w-[1100px] ">

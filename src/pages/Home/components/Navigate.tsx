...
export const Navigate = () => {
  const { onChangeCatalog, setOnChangeCatalog } = ContextCartApp()
  ...
  return (
    <nav className="flex items-center scrollbar justify-center gap-6 mt-8 w-full text-orange-500">
      ...
      >
        <div className="flex items-center border-1 justify-center rounded-full p-2  right-0  text-white bg-orange-500 group-data-[active=true]:bg-white group-data-[active=true]:text-orange-500">
          <Pizza />
        </div>
        Pizza's
      </button>
